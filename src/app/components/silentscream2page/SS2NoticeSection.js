...
const SS2NoticeSection = () => {
  return (
    <div>
      <div className="w-full flex justify-center items-center">
        {/* Laptop View */}
        <div
          className="md:flex hidden md:w-[1320px] md:h-[288px] bg-ss2-banner-ls
        ...
        {/* Mobile View */}
        <div
          className="flex md:hidden w-[290px] h-[300px] bg-ss2-banner-ms
...
export default SS2NoticeSection;
